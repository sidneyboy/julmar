  ...
  <div class="wrapper">
          ...
          <div class="row invoice-info" style="width:70%;margin-left: 20%;margin-right: 20%;">
              ...
              <div class="col-sm-6 invoice-col">
                  <table>
                      ...
                      <tr>
                          <td style="font-weight: bold;">Phone # <span class="float-right">:</span></td>
                          <td> {{ $principal_contact_number }}</td>
                      </tr>
                      <tr>
                          <td style="font-weight: bold;">SO # <span class="float-right">:</span></td>
                          <td style="font-weight: bold;"> {{ $sales_order_number }}</td>
                      </tr>
                  </table>
              </div>
              <!-- /.col -->
              <div class="col-sm-6 invoice-col">
                  <table>
                      <tr>
                          ...
                          <td style="font-weight: bold;"> {{ $purchase_id }}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td style="font-weight: bold;">Payment Due <span class="float-right">:</span></td>
                          <td> {{ $payment_term }}</td>
                      </tr>
                      <tr>
                          <td style="font-weight: bold;">Delivery Term <span class="float-right">:</span></td>
                          <td>
                              {{ $delivery_term }}
                          </td>
                      </tr>
      ...
      <!-- /.content -->
      <div class="container">
          <button id="click_me" class="float-right">PRINT !</button>
      </div>
  </div>
