<form id="invoice_out_sales_invoice_final_summary">
    @csrf
...
<script>
    ...
    $("#invoice_out_sales_invoice_final_summary").on('submit', (function(e) {
        e.preventDefault();
        $('#loader').show();
        $.ajax({
            url: "invoice_out_sales_invoice_final_summary",
            type: "POST",
