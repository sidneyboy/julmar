<form id="purchase_order_confirmation_saved">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center">Discount
                            @foreach ($discount_selected->principal_discount_details as $data)
                                ...
                                @endif
                            @endforeach
                            {{ $discount_selected->total_discount }}%
                        </th>
                ...
                <tbody>
                    @foreach (array_filter($quantity_confirmed) as $key => $data)
                        <tr>
                            ...
                            <td style="text-align: right">
                                @php
                                    $discount = $total_amount * ($discount_selected->total_discount / 100);
    ...
    <input type="hidden" value="{{ $discount_selected->cash_with_order_discount }}"
        name="cash_with_order_discount_rate">
