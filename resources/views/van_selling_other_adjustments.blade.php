 ...
 @section('title', 'VS OTHER ADJUSTMENTS')
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: bold;">VAN SELLING OTHER ADJUSTMENTS FORM</h3>
        ...
        <div class="card-body">
        <form id="van_selling_other_adjustments_save">
            @csrf
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="other_adjustments" class="form-control" required>
              </div>
              <div class="col-md-12">
                <label>&nbsp;</label>
...
<script>
 ...
 $("#van_selling_other_adjustments_save").on('submit',(function(e){
      e.preventDefault();
      $('.loading').show();
        $.ajax({
          url: "van_selling_other_adjustments_save",
          type: "POST",
