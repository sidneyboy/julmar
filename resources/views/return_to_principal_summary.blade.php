<form id="return_to_principal_save">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">INVENTORY
                            {{ $received_purchase_order->principal->principal }}</td>
                        <td></td>
                        <td style="font-weight: bold;text-align: center;"><?php echo number_format($total_final_cost * -1, 2, '.', ','); ?>
    ...
    <input type="hidden" value="{{ $bo_allowance_layer }}" name="bo_allowance_layer">
