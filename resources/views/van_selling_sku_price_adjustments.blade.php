    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: bold;">VAN SELLING SKU PRICE ADJUSTMENTS</h3>
        ...
        <div class="card-body">
        <form id="van_selling_sku_price_adjustments_generate">
            @csrf
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-12">
               <div id="van_selling_sku_price_adjustments_proceed_page"></div> 
              </div>
        ...
        <div class="card-footer">
         <div id="van_selling_sku_price_adjustments_generate_page"></div>
        </div>
        <!-- /.card-footer-->
      </div>
      <!-- /.card -->
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: bold;">VAN SELLING SKU PRICE ADJUSTMENTS FINAL SUMMARY</h3>
        ...
        <div class="card-body">
          <div id="van_selling_sku_price_adjustments_generate_final_summary_page"></div>
        </div>
        <!-- /.card-body -->
        <div class="card-footer">
...
<script>
  ...
  $("#proceed_button").click(function() {
    ...
    $.ajax({
      url: "van_selling_sku_price_adjustments_proceed",
      type: "POST",
      data:  'reservation=' + reservation + '&customer_id=' + customer_id,
      success: function(data){
        $('#van_selling_sku_price_adjustments_proceed_page').html(data);
 ...
 $("#van_selling_sku_price_adjustments_generate").on('submit',(function(e){
      e.preventDefault();
      //$('.loading').show();
        $.ajax({
          url: "van_selling_sku_price_adjustments_generate",
          type: "POST",
          ...
          success: function(data){
            if(data == 'NO_DATA'){
              ...
              $('#van_selling_sku_price_adjustments_generate_page').html(data);
            }
          },
        });
    }));
