            ...
            <form id="customer_discount_save" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="principal" id="principal" required class="form-control" style="width:100%;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Store</label>
                                <select name="store" id="store" required class="form-control select2bs4"
                                    style="width:100%;">
                                    <option value="" default>Select</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" style="width:100%;" name="number_of_discounts"
                ...
                <div class="card-footer">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" id="save_new_discount" style="display: none;"
                                    class="btn btn-success btn-block">SAVE CUSTOMER DISCOUNT</button>
                            </div>
                        </div>
                    </div>
                </div>
