...
<div class="row">
    <div class="col-md-12">
        <button class="btn btn-success btn-sm float-right"
            onclick="exportTableToCSV('{{ strtoupper($sales_invoice->agent->full_name) . ' - ' . strtoupper($sales_register_store_name) . ' SALES REGISTER - ' . $date . '-' . $sales_invoice->sku_type }}.csv')">Export</button>
    </div>
</div>
