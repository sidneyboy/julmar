  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-12 invoice-col">
        ...
        <br />
        <center>
        <span style="font-weight: bold;font-size:18px;text-transform: uppercase;">TRANSFER TO BRANCH #: {{ $id }} ({{ $principal_name }}) </span><br />
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          @foreach($transfer_to_bran_details as $data)
            <tr>
              ...
              <td style="text-transform: uppercase;text-align: center">{{ $data->quantity }}</td>
               <td style="text-transform: uppercase;text-align: center">{{ number_format($data->final_unit_cost,2,".",",")  }}</td>
          ...
          <tr>
            ...
            <td style="text-align: center;font-weight: bold;">{{ number_format(array_sum($sum_total_amount),2,".",",")  }}</td>
          </tr>
        </tbody>
      </table>
    </div>
