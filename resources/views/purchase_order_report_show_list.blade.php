                    ...
                    <td style="text-align: center;">
                        ...
                        @else
                            <button type="button" class="btn btn-link" data-toggle="modal"
                                data-target="#particulars{{ $data->id }}">
                                Show
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="particulars{{ $data->id }}" tabindex="-1" role="dialog"
                    ...
                    <td style="text-align: center;">
                        @if ($data->po_confirmation_image != '')
                            <button type="button" class="btn btn-sm btn-block btn-info" data-toggle="modal"
                                data-target="#confirmation_image{{ $data->id }}">
                                Confirmation Image
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="confirmation_image{{ $data->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog mw-100 w-75" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold;">
                                                UPLOADED CONFIRMATION IMAGE</h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{ route('confirmation.upload.post') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>Uploaded Image</label>
                                                    <img src="{{ asset('/images/' . $data->po_confirmation_image) }}"
                                                        style="width:100%;">
                                                </div>
                                                <div class="form-group">
                        ...
                        @else
                            <button type="button" class="btn btn-sm btn-block btn-info" data-toggle="modal"
                                data-target="#upload_confirmation_image{{ $data->id }}">
                                Upload and Update Remarks
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="upload_confirmation_image{{ $data->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">UPLOAD CONFIRMATION IMAGE
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <form action="{{ route('confirmation.upload.post') }}" method="POST"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <img id="blah"
                                                        src="{{ asset('/adminLte/default_image.jpg') }}"
                                                        style="width:100%;border-radius: 1px 1px 0px 0px;"
