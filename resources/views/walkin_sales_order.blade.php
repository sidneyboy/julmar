                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" required name="customer" id="customer"
                                    style="width:100%;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Type:</label>
                                <select class="form-control" required name="type" id="type" style="width:100%;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="principal_id" id="principal_id"
                                    style="width:100%;">
    ...
    <script>
        ...
        $("#principal_id").change(function() {
            ...
            $.post({
                ...
                data: 'principal_id=' + principal_id + '&type=' + type + '&price_level=' + price_level +
                    '&customer=' + customer,
