...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title" style="font-weight: bold;">VAN CALLS REPORT</h3>
    </div>
    <div class="card-body">
      <form id="van_selling_calls_report_generate_data">
        <div class="row">
          <div class="col-md-6">
    ...
    <div class="card-footer">
        <div id="van_selling_calls_report_generate_data_page"></div>
    </div>
    <!-- /.card-footer-->
  </div>
  <!-- /.card -->
...
<script>
  ...
  $("#van_selling_calls_report_generate_data").on('submit',(function(e){
      e.preventDefault();
      $('.loading').show();
        $.ajax({
          url: "van_selling_calls_report_generate_data",
          type: "POST",
          ...
          success: function(data){
             if (data == 'no_data_found') {
              ...
              $('#van_selling_calls_report_generate_data_page').html(data);
              $('.loading').hide();
             }
