 ...
 @section('title', 'Customer CM For RGS')
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: bold;">CUSTOMER CREDIT MEMO FOR RGS</h3>
        ...
        <div class="card-footer">
          <div id="customer_credit_memo_for_rgs_show_dr_details"></div>
        </div>
        <!-- /.card-footer-->
      </div>
      <!-- /.card -->
...
<script>
 ...
 $("#search_dr_for_credit_memo").on('submit',(function(e){
      ...
      //$('.loading').show();
        $.ajax({
          url: "customer_credit_memo_for_rgs_show_dr_details",
          type: "POST",
          ...
          success: function(data){
            ...
            if(data == 'non_existing_pcm_number'){
              Swal.fire(
                 'NON EXISTING PCM #, CANNOT PROCEED!!',
                 '',
                 'error'
               )
              $('.loading').hide();
              ...
              $('.loading').hide();
              $('#customer_credit_memo_for_rgs_show_dr_details').html(data);
            }
          },
        });
    }));
