        ...
        <tbody>
            @foreach ($sku as $data)
                <tr>
                    ...
                    <td style="text-transform: uppercase;text-align: center;">{{ $unit_of_measurement[$data->sku_id] }}</td>
                    ...
                    <td style="text-align: right;">
                        @php
                            $difference = $unit_cost[$data->sku_id] + $unit_cost_adjustment;
                        @endphp
                        ...
                        <input type="hidden" name="unit_cost[{{ $data->sku_id }}]" value="{{ $unit_cost[$data->sku_id] }}">
