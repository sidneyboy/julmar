    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="font-weight: bold;">RECEIVING DETAILED REPORT</h3>
                        ...
                        <table class="table table-bordered table-sm table-hover table-striped">
                            ...
                            <tbody>
                                @foreach ($received_purchase_order->received_purchase_order_details as $details)
                                    <tr>
                                        <td><span
                                                style="color:green;font-weight:bold;">{{ $details->sku->sku_code }}</span>-
                                        ...
                                        <td style="text-align: right">{{ number_format($details->unit_cost, 2, '.', ',') }}
                                        </td>
                                        ...
                                        <td style="text-align: right">
                                            @php
                                                $bo_allowance_discount =
                                                    $total_amount *
                                                    ($received_purchase_order->bo_allowance_discount_rate / 100);
                                        ...
                                        <td style="text-align: right">
                                            @php
                                                $cwo_discount =
                                                    $total_amount * ($received_purchase_order->cwo_discount_rate / 100);
                            ...
                            <tbody>
                                @foreach ($received_purchase_order->received_purchase_order_details as $details)
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            {{ number_format($details->unit_cost, 2, '.', ',') }}</td>
                                        <td style="text-align: right">
                                            @php
                                                $total_amount = $quantity_final * $details->unit_cost;
                                                $sum_total_amount[] = $total_amount;
                                        ...
                                        @php
                                            ...
                                            $percent = [];
                                            foreach (
                                                $received_purchase_order->received_discount_details
                                                as $data_discount
                                            ) {
                                                $discount_value_holder_dummy = $discount_value_holder;
                                                $less_percentage_by = $data_discount->discount_rate / 100;
