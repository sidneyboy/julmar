                ...
                <form id="van_selling_sales_report_generate">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2bs4" required id="customer_id" name="customer_id"
                                style="width:100%;">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2bs4" required id="search_for" name="search_for"
                                style="width:100%;">
                        ...
                        <div class="col-md-12">
                            <br />
                            <button type="button" class="btn btn-info btn-sm float-right" id="proceed">Proceed</button>
                            <button type="submit" class="btn btn-success btn-sm float-right" id="generate_report"
                                style="display: none">Generate</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        $("#proceed").click(function() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: 'search_for=' + search_for + '&customer_id=' + customer_id + '&reservation=' +
                    reservation,
