...
class CreateSalesInvoiceAccountsReceivablesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_invoice_accounts_receivables', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sales_invoice_accounts_receivables');
    }
}
