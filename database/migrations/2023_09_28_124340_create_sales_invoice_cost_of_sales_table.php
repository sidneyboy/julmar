...
class CreateSalesInvoiceCostOfSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_invoice_cost_of_sales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sales_invoice_cost_of_sales');
    }
}
