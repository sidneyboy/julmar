...
class Receive_order_report_controller extends Controller
{
    ...
    public function receive_order_report_list(Request $request)
    {
        ...
        // $b = Return_to_principal::select('total_amount_return','date')->where('principal_id', $principal_id)->whereBetween('date', [$date_from, $date_to])->get();

        // $c = Bo_allowance_adjustments::select('net_deduction', 'date')
        //            ->where('principal_id', $principal_id)->whereBetween('date', [$date_from, $date_to])->get();
        ...
        //   $received_order_data = Received_purchase_order::select('id','discount_id','principal_id','dr_si','vatable_purchase','less_discount','net_discount','vat_amount','grand_final_total_cost','total_bo_allowance','total_every_discount','date','invoice_image')->where('principal_id', $principal_id)->whereBetween('date', [$date_from, $date_to])->get();
        ...
        //   $bo_adjustment_data = Bo_allowance_adjustments::select('id','received_id','principal_id','bo_allowance_deduction','vat_deduction','net_deduction','date','particulars')->where('principal_id', $principal_id)->whereBetween('date', [$date_from, $date_to])->get();

        //   $invoice_cost_data = Invoice_cost_adjustments::select('id','received_id','principal_id','total_invoice_adjusted','total_bo_allowance','vatable_purchase','less_discount','net_discount','vat_amount','net_adjustment','date','particulars')->where('principal_id', $principal_id)->whereBetween('date', [$date_from, $date_to])->get();
        ...
        //   if ($received_order_data) {
        //     foreach ($received_order_data as $key => $data) {
        //        $received_discount_rate[] = Principal_discount_cifpi::find($data->discount_id);
        //     }
        //   }else{
        //       $received_discount_rate[] = '';
        //   }
        ...
        //   if ($return_order_data) {
        //     foreach ($return_order_data as $key => $data) {
        //        $return_discount_rate[] = Principal_discount_cifpi::find($data->discount_id);
        //     }
        //   }else{
        //       $return_discount_rate[] = '';
        //   }
        ...
        //   if ($received_order_data) {
        //     foreach ($received_order_data as $key => $data) {
        //        $received_discount_rate[] = Principal_discount_alaska::find($data->discount_id);
        //     }
        //   }else{
        //       $received_discount_rate[] = '';
        //   }
        ...
        //   if ($return_order_data) {
        //     foreach ($return_order_data as $key => $data) {
        //        $return_discount_rate[] = Principal_discount_alaska::find($data->discount_id);
        //     }
        //   }else{
        //       $return_discount_rate[] = '';
        //   }
        ...
        //   if ($return_order_data) {
        //     foreach ($return_order_data as $key => $data) {
        //        $return_discount_rate[] = Principal_discount_pfc::find($data->discount_id);
        //     }
        //   }else{
        //       $return_discount_rate[] = '';
        //   }
        ...
        //   if ($return_order_data) {
        //     foreach ($return_order_data as $key => $data) {
        //        $return_discount_rate[] = Principal_discount_epi::find($data->discount_id);
        //     }
        //   }else{
        //       $return_discount_rate[] = '';
        //   }
        ...
        //   if ($return_order_data) {
        //     foreach ($return_order_data as $key => $data) {
        //        $return_discount_rate[] = Principal_discount_dole::find($data->discount_id);
        //     }
        //   }else{
        //       $return_discount_rate[] = '';
        //   }
