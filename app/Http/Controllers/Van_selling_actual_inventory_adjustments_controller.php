...
class Van_selling_actual_inventory_adjustments_controller extends Controller
{
    ...
    public function van_selling_inventory_adjustments_show_sku(Request $request)
    {
        ...
        $van_selling_ledger = DB::table('Van_selling_upload_ledgers')
            ->select('id', 'sku_code', 'description', 'unit_price')
        ...
        return view('van_selling_inventory_adjustments_show_sku', [
