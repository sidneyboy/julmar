          ...
          <div class="container">
            <div class="panel panel-default">
              <div class="panel-body" style="color:red;">
                <h1>PALIHOG CHECK SA VS AR LEDGER KONG NAA NABA SIYA BEGINNING BEFORE MAG IN SA IYANG INVENTORY AND NEW VANLOADS SALAMAT</h1>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control select2" required name="location_id" id="location_id" style="width:100%;">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control select2" required name="sku_type" id="sku_type" style="width:100%;">
   ...
   $("#principal").on('change',(function(e){
      ...
      var sku_type = $('#sku_type').val();
        ...
        $.ajax({
          ...
          type: "POST",
          data:  'principal=' + principal + '&location_id=' + location_id + '&sku_type=' + sku_type,
