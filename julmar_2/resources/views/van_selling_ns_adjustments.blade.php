 ...
 @section('title', 'VAN SELLING NS ADJUSTMENTS FORM')
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: bold;">VAN SELLING NS ADJUSTMENTS FORM</h3>
        ...
        <div class="card-body">
        <form id="van_selling_ns_adjustments_save">
            @csrf
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label>NS ADJUSTMENTS:</label>
                <input type="text" name="ns_adjustments" class="form-control" required>
              </div>
              <div class="col-md-12">
                <label>&nbsp;</label>
...
<script>
 ...
 $("#van_selling_ns_adjustments_save").on('submit',(function(e){
      e.preventDefault();
      $('.loading').show();
        $.ajax({
          url: "van_selling_ns_adjustments_save",
          type: "POST",
