          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control select2" required name="customer" style="width:100%;">
                  <option value="" default>Select</option>
                  @foreach($customer as $data)
                  <option value="{{ $data->id .",". $data->store_name }}">{{ $data->store_name ." - ". $data->location->location }}</option>
                  @endforeach
                </select>
              </div>
            </div>
