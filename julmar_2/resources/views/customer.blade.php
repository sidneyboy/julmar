            ...
            <div class="row">
              ...
              <div class="col-md-6">
               ...
               <div class="col-md-6">
                ...
                <input type="text" class="currency-default" name="credit_line_amount" required style="display: block;
                  width: 100%;
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>&nbsp;</label>
                  <button type="submit" class="btn btn-success btn-block">SUBMIT NEW CUSTOMER</button>
                </div>
              </div>
            </div>
          </form>
              ...
              <tbody>
                 @foreach($customer as $data)
                  <tr>
                    ...
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->kind_of_business }}</td>
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->credit_term }}</td>
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->credit_line_amount }}</td>
                    <td style="text-align: center;text-transform: uppercase;">
                      
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal_location{{ $data->id }}">
                        {{ $data->location->location }}
                      </button>

                      <!-- Modal -->
                      <div class="modal fade" id="exampleModal_location{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">{{ $data->store_name }}</h5>
                    ...
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->detailed_location }}</td>
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->detailed_location }}</td>
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->contact_person }}</td>
                    <td style="text-align: center;text-transform: uppercase;">{{ $data->contact_number }}</td>
                    <td>
                      <!-- Button trigger modal -->
                      ...
                      <div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">ADDITION INFORMATION</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                              <table class="table table-bordered table-hover">
                                <thead>
                                  <tr>
                                    <th colspan="2" style="font-weight: bold;text-align: center;">PRICE LEVEL PER PRINCIPAL</th>
                                  </tr>
                                  <tr>
                                    <th>Principal</th>
                                    <th>Price Level</th>
                                ...
                                <tbody>
                                  @foreach($data->customer_discount as $discount_rate)
                                    <tr>
                                      ...
                                      <td style="text-align: center;">{{ number_format($discount_rate->customer_discount,2,".",",") }}</td>
                                    </tr>
                                  @endforeach
                                </tbody>
                              </table>
