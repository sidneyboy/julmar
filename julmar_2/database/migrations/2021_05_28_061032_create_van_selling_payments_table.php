...
class CreateVanSellingPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('van_selling_payments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('van_selling_payments');
    }
}
